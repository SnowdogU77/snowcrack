...
def Ghsh323():
    hs='80000000'
    if len(hsh)==len(hs) and hsh.isdigit()==True and hsh.isalpha()==False and hsh.isalnum()==True:
        jerar.append("103040")
def Ghsh325():
    hs='85318985'
    if len(hsh)==len(hs) and hsh.isdigit()==True and hsh.isalpha()==False and hsh.isalnum()==True:
...
def DESUnix():
    hs='ZiY8YtDKXJwYQ'
    if len(hsh)==len(hs) and hsh.isdigit()==False and hsh.isalpha()==False:
        jerar.append("104020")
...
def LineageIIC4():
    ...
    if len(hsh)==len(hs) and hsh.isdigit()==False and hsh.isalpha()==False and hsh.isalnum()==True and hsh[0:2].find('0x')==0:
        jerar.append("107080")
def MD5phpBB3():
    hs='$H$9kyOtE8CDqMJ44yfn9PFz2E.L2oVzL1'
    if len(hsh)==len(hs) and hsh.isdigit()==False and hsh.isalpha()==False and hsh.isalnum()==False and hsh[0:3].find('$H$')==0:
        jerar.append("107040")
def MD5Unix():
    hs='$1$cTuJH0Ju$1J8rI.mJReeMvpKUZbSlY/'
    if len(hsh)==len(hs) and hsh.isdigit()==False and hsh.isalpha()==False and hsh.isalnum()==False and hsh[0:3].find('$1$')==0:
        jerar.append("107060")
def MD5Wordpress():
    hs='$P$BiTOhOj3ukMgCci2juN0HRbCdDRqeh.'
    if len(hsh)==len(hs) and hsh.isdigit()==False and hsh.isalpha()==False and hsh.isalnum()==False and hsh[0:3].find('$P$')==0:
        jerar.append("107020")

def MD5APR():
    hs='$apr1$qAUKoKlG$3LuCncByN76eLxZAh/Ldr1'
    if len(hsh)==len(hs) and hsh.isdigit()==False and hsh.isalpha()==False and hsh[0:4].find('$apr')==0:
        jerar.append("108020")
...
def MySQL160bit():
    ...
    if len(hsh)==len(hs) and hsh.isdigit()==False and hsh.isalpha()==False and hsh.isalnum()==False and hsh[0:1].find('*')==0:
        jerar.append("109060")
def RipeMD160():
...
def MD5passsaltjoomla1():
    ...
    if len(hsh)==len(hs) and hsh.isdigit()==False and hsh.isalpha()==False and hsh.isalnum()==False and hsh[32:33].find(':')==0:
        jerar.append("112020")

def SHA1Django():
    hs='sha1$Zion3R$299c3d65a0dcab1fc38421783d64d0ecf4113448'
    if len(hsh)==len(hs) and hsh.isdigit()==False and hsh.isalpha()==False and hsh.isalnum()==False and hsh[0:5].find('sha1$')==0:
        jerar.append("113020")
...
def SAM():
    ...
    if len(hsh)==len(hs) and hsh.isdigit()==False and hsh.isalpha()==False and hsh.isalnum()==False and hsh.islower()==False and hsh[32:33].find(':')==0:
        jerar.append("116040")

def SHA256Django():
    hs='sha256$Zion3R$9e1a08aa28a22dfff722fad7517bae68a55444bb5e2f909d340767cec9acf2c3'
    if len(hsh)==len(hs) and hsh.isdigit()==False and hsh.isalpha()==False and hsh.isalnum()==False and hsh[0:6].find('sha256')==0:
        jerar.append("117020")
...
def SHA256s():
    ...
    if len(hsh)==len(hs) and hsh.isdigit()==False and hsh.isalpha()==False and hsh.isalnum()==False and hsh[0:3].find('$6$')==0:
        jerar.append("120020")

def SHA384Django():
    hs='sha384$Zion3R$88cfd5bc332a4af9f09aa33a1593f24eddc01de00b84395765193c3887f4deac46dc723ac14ddeb4d3a9b958816b7bba'
    if len(hsh)==len(hs) and hsh.isdigit()==False and hsh.isalpha()==False and hsh.isalnum()==False and hsh[0:6].find('sha384')==0:
